"""
Django settings for seko project.
...
env = environ.Env()
environ.Env.read_env(env_file='../.env')  # Adjust path as needed
...
CORS_ALLOW_ALL_ORIGINS = True   # for dev only; set CORS_ALLOWED_ORIGINS in prod
